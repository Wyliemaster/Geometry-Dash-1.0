...
public:
    ...
    cocos2d::CCSprite *m_pWhiteSquare;
    cocos2d::CCSprite *m_pWhiteSquare2;
    cocos2d::CCSprite *m_pFloorLine;
    cocos2d::CCSprite *m_pFloorLine2;
    cocos2d::CCLayer *m_pSomeLayer;
    cocos2d::CCLayer *m_pGroundLayer1;
    cocos2d::CCLayer *m_pGroundLayer2;
